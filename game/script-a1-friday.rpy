...
"Yeah, that sounds good. Screw this running crap."
...
"I'd really rather not have Emi concerned about me though it seems to be too late."

"Heck, I'd really rather not have anyone concerned about my condition, though at this point, that too seems to be too late."
...
"Damn it, not even a week and I end up like this again. I really screwed up this time. Should've known better than to play the half-baked sportstar in front of a real one."
...
"I have to be more careful, or I will end up in hospital again, or worse."
...
"The nurse looks up from his work, sitting exactly where he was sitting before."
...
nk "I can try and help you keeping your health, but ultimately the last call lies with you. Hopefully this little episode will be something that’ll remind you of that."
...
"The sun stings my eyes, so I head to left, to the main school building."
...
"Back in my room, the first thing I see is the familiar row of medication bottles lined up on on top of my dresser, and it makes me depressed, as usual."
...
"They are not stupid, and probably can at least half-way guess what's going on with me. And…"
...
"I shrug and he gestures me to run along so I naturally do."
...
"Only two eyepairs remain keenly following me as I walk to my seat."
...
"It was just my wishful thinking. She just talked about it with Shizune, probably devising ways to get me spill the beans."
...
"As the words leave my mouth, I immediately regret saying them, but it's not like I can take them back anymore."
...
"For a change, I'm not amongst the first ones to come to morning class."
...
"Mutou deliberates for a moment, but since almost nobody seems to pay attention anymore, he gives up and sits down."
...
"I suppose I'll grab another book or two while I'm here. There's not much else to do, and after reading so much during my stay in hospital, it's become a hard habit to break."
...
"I quickly walk up to her, an act which seems to catch her attention without a word needing to being said."
...
"Lilly sounds as if she's spotted an opening for some kind of discernably normal conversation. I can't say I share her optimism."
...
"Her eyes widen in shock and she jolts back in a somewhat artificial way, making it seem like a act rehearsed for situations like this."
...
"I resist the urge to say “Aside from our travelling companion?” But only just."
...
"Now that she brings it up, I notice that my breathing is surprisingly heavy. The uphill walk has really done a job on me."
...
menu:
    ...
    "Despite Rin being in her own world, Lilly noticed it all too quickly…"
    
    "Sorry, I'm not in really good condition.":
        return m1
...
hi "I'm fine, I'm fine."

show lilly cane_sad_ni at twoleft
with charachange

li "You… don't sound like you're fine."

show rin basic_deadpansurprised_ni at tworight
with charachange

rin "He doesn't look fine either."

"Lilly's questioning has piqued Rin's curiosity. Just great."

show lilly cane_concerned_ni at twoleft
with charachange

li "You shouldn't push yourself if there is something—{w=.5}{nw}"

hi "I said I'm fine, all right?"
...
"I almost yell, inadvertedly, but it's not like it matters."

"For a moment Lilly looks to be about to protest at my tone, but she keeps quiet."

"Rin is unfazed as she would be, though there is something in her expression that belies her own confusion."

"For an embarrasingly long time, not a word is exchanged between us. I want to take it back, but that's not possible now."

hi "Sorry. That was… too much."

hide lilly
hide rin
with charaexit

"I take off, leaving the girls behind. I instantly regret the move, but I can't help myself."

"I'm running away, running away from facing myself. Even realizing what a coward I am, I don't stop."
...
hi "Maybe we should we call someone? She sounded like she was going into shock or something."
...
"So my guess was right. Lilly offers a slight, apologetic smile as if she was sorry that her own shortcomings have prevented her to become closer with Rin."
