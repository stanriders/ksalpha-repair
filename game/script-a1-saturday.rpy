...
"Fatigue has made the class antisocial; not a peep is heard amongst the ruffling papers."
...
"It's weird that Lilly comes all the way to our classroom to pick her up. It's a round trip for her, and I expect moving around is at least nominally harder for her than it is for Hanako."
...
"My mechanical pencil lead splinters against the paper just when I was about to finish a paragraph."

"The sounds of my irritated sigh and subsequent fumbling around for a replacement feel like they're breaking the mood in the classroom."
...
"She stands on tiptoes to look on the topmost shelf, but it's not quite enough."
...
rin "So artists can't find romance, their favorite TV shows are cancelled, or they die young because of an unspecified disease. It's a deep and mysterious law of the universe."
...
"Rin doesn't give that kind of an air. Thinking about it, she doesn't give any kind of air, or a different kind every time I talk with her."
...
no "Also, Monday's club meeting is off, since I'm going out of town. I guess you kids can do something amongst yourselves, if you want to."
...
"Art and I haven't worked well together in past, at least judging from the grades I used to have in middle school."

"Maybe a club will be different than an obligatory class. Who knows?"

"I try to come up with something meaningful to ask about it, but come up with nothing."
...
"Rin shrugs noncommitally, but it still gives an impression of her general displeasure at the idea of having to discuss her painting, or any painting, with other people."
...
rin "Have you ever talked about being bored? It's pointless and not very exciting. All you can really say about is “I'm so bored.” I once spent a week trying to think of something meaningful to say about boredness."
...
hi "A little. Can't all be in shape, you know."
...
"Giving into one of my worst vices, procrastination, I decide that history is a subject best studied on a Sunday. Or a Monday. Or on any day other than this one."
...
n "Whoa there, hold up cowboy."

n "You're coming up on an important junction."
...
"Not that I mind. Letting them to their chatting, I sit back and continue drinking the pleasantly aromatic coffee."
...
"It becomes slightly unsettling as I subconciously focus on that fact."
...
hi "Alright, then, I don't think I'd be missing much. What do you have in mind?"
...
"We make it to the tea shop with a half an hour's walk. It seems that we are the only customers around."
...
"We take our seats at a large, round marble table, and it hits me that I don't know what this place serves. I just went with what Yuuko recommended the last time."
...
mi "We're regulars, we come here so often that we don't have to do that anymore!"
...
"If I finish first, the laws of chivalry would make me look like a jerk, as I would need to run out of this tea house, leaving her to pay for everything. That could also be considered a loss. She would use that."
...
mi "This is just a bad year. Fewer people than usual, even though the year before, we had even less."
...
mi "Then, Shicchan could go get fresh boxes of tacks for all us at the same time. You know, for efficiency~!"
...
mi "Alright, alright! And you, Shicchan?"
...
mi "And here's how much it all costs: 3685 yen! Wahahahaha~!"

hi "Well, I don't know in how many situations I'll need to remember such an exact number…"

mi "Ahahahaha! Okay~! I'm going to order now, in case anyone wants something else. No objections? Alright alright, then!"
