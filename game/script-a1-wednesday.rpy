...
mi "It's a tea house, Hicchan~!"

"A tea house… that sounds kind of fancy."
...
"I've never actually been to a tea house before. All my expectations are from what I've seen about them on TV. But those are period dramas, and these are modern times. It might just be a regular café, and they're just calling it a tea house."
...
"Lilly walks besides the wall, letting her cane gently tap against it every now and then. Hanako comes along right beside her, so close that she is practically half-hugging her as they go."
...
"Hanako shrieks a little and my vision briefly goes black."
...
"We arrive at the tea house in what Misha says is “record time,” likely because of Shizune's blazing pace. I feel a little let down seeing that it's not a huge feudal-era building with mats on the floor and women in kimonos pouring the tea."

"It actually is more like a café, like I thought. Not that that's a bad thing. It looks very nice."
...
"Even if I were to start heading back to school right now, it would take at least… fifteen minutes? Maybe. I can't risk running fast with my condition, so it would take at least that long to get there."
...
"It's strange, I almost miss them. The room empties quickly, and I'm the last one out the door. The second I enter the hallway, however, an arm lowers itself in front of me like a toll bridge gate, stopping me in my tracks."
...
"I really shouldn't, but I guess just this once would be alright."
...
li "Hmm… well, I've been here since the start of middle school."

li "Hanako joined at the start of high school, if memory serves me right."
...
li "Hanako lives next door to me, so it's only natural, right?"
...
"It isn't long before the bells are signalling the end of the break. Like me, the girls pack up their lunches as efficiently as they set them out."
...
"It bothers me, even moreso because of the talk with Mutou just before."

"Joking about these matters doesn't feel appropriate at all."
...
mi "Popularity aside, please don't do that anymore."
...
"The hallway is quiet and empty now with Shizune and Misha gone too, so we too leave towards the stairwell at the other end."
...
"Stacks of what seem to be paint cans are arranged in piles on the ground, besides the wall."
...
"Apart from the rare few words when discussing paint mixes, neither of us says a word for the longest times."
