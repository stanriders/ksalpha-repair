...
"So eventually I do rise up, swallow the morning medications and put on my old soccer clothes."

"Thanks to my condition, I was exempted from taking part in gym classes at Yamaku, so I didn't get issued with a gym outfit."

"I'd order some to cover such a contingency, but wearing my old soccer clothing is kind of nostalgic."
   
"I can't use them for that anymore, so maybe they can get a new life this way. A bit like me."
...
"I'm the first person in class today, although I think I'm a little too early. Then again, sitting alone here for twenty minutes sure beats having to suffer the same minutes with Kenji."
...
"She emphasises the last sentence much to my surprise. She knows about Shizune and Misha's efforts to rope me into the student council?"
...
"The air between them ripples with the heat of their enmity. Well, not really. They can't disguise it anymore, though. Even Misha looks like she's beginning to understand the real nature of this conversation."
...
"And so is Lilly's, though she keeps quiet. I'm afraid I inadvertedly pissed her off."
...
"Eventually, Lilly leaves our classroom and Shizune and Misha seat theirselves, without talking to me."
...
mi "Right~!, I mean, now that you've decided to help us, completely of your own free will,"

mi "I'll be able to take it easy! Lucky~, huh?"
...
"But, just the fact that she is alright with telling me this shows me that she doubts I'll be able to act on it."
...
hi "Alright. I guess it can't hurt, so, why not?"
...
"I leave the room, feeling totally wiped out. The grounds are totally deserted, and the school looks pretty ominous this late. The council office is the only window with lights on anymore."
...
rin "I'm not pushing myself, Hisao."
...
"That, or I manage to draw something disfigured and promptly get frustrated at my inability to put the picture in my head on the paper and call it quits without really even trying to make an effort."

"Unlike this girl. She makes me frustrated too. Being with her is like looking into a mirror that doesn't reflect anything."
...
rin "What other reason there possibly could be? Well, if there is, it's an eternal mystery. I didn't follow her in there."
...
"Rin has already grasped a brush and is dipping it into fresh paint, so of course she can't hear me anymore or doesn't answer anything even if she does."
...
"Even as we climb towards the second floor, she doesn't seem to relax."
...
"Finding her amongst the din is surprisingly easy, not the least because of her looks."
...
"Somewhat uncharacteristically, Lilly gives a noticable sigh of relief."

show lilly basic_weaksmile at twoleft
with charachange

li "Ah, that's a relief. This might actually get finished before everyone goes off to dinner, now."
...
"Aside from Hanako and myself, there's only Kenji left finishing off a sign as well as Lilly and a couple of students talking amongst themselves in the classroom."
