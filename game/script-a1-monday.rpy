...
n "The world around me; the canopy of bare branches, the dull winter sky, Iwanako running towards me; all these fade to black."

n "The last things I remember before slipping away are the sounds of Iwanako screaming for help and the incessant clatter of the branches above…"
...
n "In that whole time, I can probably count the times I've left this hospital room unsupervised on one hand."
...
n "My parents, I think, were hit harder by the news than I was. They practically had two hemorrhages apiece."

n "I had already had a full day by then to digest everything. To them, it was all fresh. They were even prepared to sell our house in order to pay for a cure."

n "Of course there isn't a cure."

nvl clear

n "Because of the late discovery of this… condition, I've had to stay at the hospital, to recuperate from the treatments."
...
n "So, I idly observed the scar that those surgeries had left on my chest slowly change its appearance over time, thinking it as some kind of an omen."

n "I still ask the head cardiologist about leaving, but my expectations are low enough now that I'm not disappointed anymore when I don't get a reply. The way he shuffles around the answer shows that there is at least some hope."
    
nvl clear

n "At some point I stopped watching TV. I don't know why, I just did."

n "Maybe it was the wrong kind of escapism for my situation."

n "I started reading instead. There was a small “library” at the hospital, although it was more like a storeroom for books. I began working my way through it, one small stack at a time. After consuming them, I would go back for more."
...
n "But I loved the stories."

nvl clear

n "That was what my life was like."

n "The days became increasingly harder to distinguish from each other, differing only by the book I was reading and the weather outside. It felt like time blurred into some kind of gooey mass I was trapped inside, instead of moving within."
...
"I don't answer to him but I smile a little, back at him."
...
"Doctor" "People with your condition usually tend to live long lives compared to other heart problems. You'll need a job one day and this is a good opportunity to continue your education."
...
"Red bricks, black wrought iron and grey plaster, assembled into a whole that didn't feel welcoming at all."
...
"With this realization set in my head and feeling nervous, I open the front door."
...
mu "Good morning everyone, sorry I am late again."
...
"An entire wall taken up by blackboards and the high, old fashioned windows set at head level only make it seem larger."
...
"Probably realizing he doesn't know anything of me, he just ends up saying my name wrong again, and asks me to write it on the blackboard."
...
mi "Do you like the school so far? We can show you around a little if you haven't had the time to walk around and…{w=0.5} familiarize?{w=0.5} yourself with it!"
...
"Still, we finish it a few minutes earlier than anyone else in the class, despite our later start. Shizune and Misha are really capable."
...
"The clock tower bells ring, signalling the end of the period. Time for lunch."
...
"Its big, arched windows give to the courtyard, towards the main gate."
...
"She shrinks deeper into her seat. I can feel her tension all the way from here, as if she was slowly turning into stone just from our presence."
...
"The room is not large and it smells strange, but a friendly-looking man turns around on his office chair to face me as I enter."
...
"Just like the main building, the halls and doors are wide to accommodate wheelchairs."
