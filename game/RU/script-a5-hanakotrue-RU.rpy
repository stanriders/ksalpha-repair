...
label ru_HT15:
    ...
    li "Полагаю, Миша имеет в виду уравнение, в котором сила равна произведению G на m1 и на m2, делённому на r в квадрате."
...
label ru_HT16:
    ...
    "Но я был не единственным, кто это заметил."
